  ...
  class UI{
      static displayReceipt(receipt){
        ...
        data.innerHTML = `
            ...
            <h3>Received a sum of INR ${receipt.rent} from ${receipt.tenantName} towards the rent of property located at ${receipt.address} for the period from ${receipt.startMonth} to ${receipt.endMonth}.</h3>
            <br /><br />
